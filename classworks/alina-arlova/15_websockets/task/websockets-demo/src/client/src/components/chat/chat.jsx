...
import { sendMessage, pushNewMessage, deleteMessage, deleteSubscribedMessage } from 'resources/message/message.actions';
...
class Chat extends React.Component {
  componentWillMount() {
    ...
    socket.on('message:removed', messageId => {
      this.props.deleteSubscribedMessage(messageId);
    });
  }
  ...
  render() {
    const messages = this.props.messages.map(message => {
      return <Message key={message._id} content={message.content} senderId={message.senderId} onClick={this.onDeleteMessage} id={message._id} />;
    });
