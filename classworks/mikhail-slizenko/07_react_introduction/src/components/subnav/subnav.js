    ...
    return (
      <div className="subnav">
        <form className="subnav__search">
          <input className="subnav__search-input" placeholder="Search" type="text" onChange={ this.handleChange }/>
        ...
        <Button text="New issue" primary  click={ this.props.openNewIssues }/>
      </div>
    );
  }
}
