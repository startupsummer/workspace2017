    ...
    return (
      <div className="issue" key={ this.props.item.id }>
        ...
        <div className="issue__title">
            <a href="#" className="issue__link">
                { this.props.item.title }
            </a>
        </div>
        { this.props.item.state === 'open' 
          ? <Button text="Close issue" click={ this.props.closeIssues(this.props.item.id) }/>
          : <Button text="Open issue" click={ this.props.openIssues(this.props.item.id) }/>
        }
      </div>
    );
  }
