...
class Chat extends React.Component {
  ...
  deleteMessage = (id) => async () => {
    ...
    await this.props.deleteMessage(senderId)
    this.setState({ content: '' });
  }
  ...
  render() {
    const messages = this.props.messages.map(message => {
      return <Message key={message._id} content={message.content} senderId={message.senderId} deleteMes={this.deleteMessage(message._id)}/>;
    });
