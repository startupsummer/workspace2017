...
import { sendMessage, pushNewMessage, deleteMessage } from 'resources/message/message.actions';
...
class Chat extends React.Component {
  ...
  render() {
    const messages = this.props.messages.map(message => {
      return <Message deleteMessage={this.props.deleteMessage} key={message._id} messageId={message._id} content={message.content} senderId={message.senderId} />;
    });
