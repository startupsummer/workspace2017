...
const IssueHeader = ({
  ...
  const itemByState = (status) => newIssues.reduce((acc, issue) => (issue.state === status ? acc + 1 : acc), 0)
  return (
...
IssueHeader.propTypes = {
  newIssues: React.PropTypes.array.isRequired,
  tab: React.PropTypes.string.isRequired,
  openState: React.PropTypes.func.isRequired,
}
