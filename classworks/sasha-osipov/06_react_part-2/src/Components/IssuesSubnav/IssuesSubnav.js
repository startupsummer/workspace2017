            ...
            <div className="issues-listing__subnav">
                <div className="subnav">
                    <form className="subnav__search">
                        <input className="subnav__search-input" type="text" placeholder="Search" onChange={ this.props.searchTitle }/>
                    ...
                    <Button btn primary text="New Issue" click={ this.props.newIssue }/> 
                </div>
            </div>
        );
    }
