...
class Chat extends React.Component {
  ...
  onDeleteMessage =  async (msgId) => {
    await this.props.deleteMessage(msgId);
  }
  ...
  render() {
    const messages = this.props.messages.map(message => {
      return <Message key={message._id} id={message._id} content={message.content} senderId={message.senderId} onDeleteMessage={this.onDeleteMessage} />;
    });
