...
import biliberda from '../../../helpers/biliberda';
...
class IssuesNav extends Component {
  ...
  onActionOpenIssue = () => {
    const { actionOpenIssue } = this.props;
    actionOpenIssue(biliberda());
  }
...
IssuesNav.propTypes = {
  ...
  actionOpenIssue: PropTypes.func.isRequired
}

export default connect(null, {
  actionOpenIssue: action.openIssue
})(IssuesNav);
